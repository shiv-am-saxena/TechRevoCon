	...
	return (
		<div className="h-full flex flex-col gap-10 w-full p-10">
			...
			<div className="flex flex-col gap-4 py-10 bg-white/40 rounded-3xl">
				...
				<div className="w-full flex flex-col lg:flex-row p-5 gap-7 items-center justify-around rounded-3xl">
				...
				<hr />
				<div className="w-full flex flex-col px-5 pt-5 gap-7 items-center justify-around">
					<iframe
